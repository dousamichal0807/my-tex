...
\def \defbyname #1{\expandafter\def \csname#1\endcsname}
...
\def \ignorespacetoksB {%
  \ifcat\space \noexpand\tmptokenA \ea\ignorespacetoksC
...
\newcount \@skiplinecount
\newdimen \@skiplineamount
\def \skiplines {
  \afterassignment\@skiplinesA
  \@skiplinecount=}
\def \@skiplinesA {%
  \@skiplineamount \the\@skiplinecount \baselineskip \relax
  \ifdim\lastskip<\@skiplineamount
    \removelastskip
    \vskip\@skiplineamount
  \fi}
